...
print('----------------------------------------------------------')
a, b, e = 3, 6, 0.01
print('Dichotomy algorithm: ', d_search_min(a, b, 0.001, e)[0])
print('Fibonachi algorithm: ', f_search_min(a, b, e)[0])
print('Parabola algorithm: ', p_search_min(a, b, e)[0])
print('Golden ratio algorithm: ', g_search_min(a, b, e)[0])
print('Brent algorithm: ', b_search_min(a, b, e)[0])
print('----------------------------------------------------------')
...
print('Dichotomy algorithm: ', d_search_min(a, b, 0.001, e)[0])
print('Fibonacci algorithm: ', f_search_min(a, b, e)[0])
print('Parabola algorithm: ', p_search_min(a, b, e)[0])
print('Golden ratio algorithm: ', g_search_min(a, b, e)[0])
print('Brent algorithm: ', b_search_min(a, b, e)[0])
print('----------------------------------------------------------')
